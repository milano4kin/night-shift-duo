...
(async()=>{
  ...
  must(source.includes("DREAD SHIFT v8.9.5 client"),"v8.9.5 client marker missing; audited release runtime is incomplete");
  ...
  must(server.includes('const BUILD_VERSION = "8.9.5";'),"v8.9.5 server marker missing before production protection");
