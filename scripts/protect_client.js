...
(async()=>{
  ...
  must(source.includes("DREAD SHIFT v8.9.3 client"),"v8.9.3 client marker missing; audited release runtime is incomplete");
  ...
  must(server.includes('const BUILD_VERSION = "8.9.3";'),"v8.9.3 server marker missing before production protection");
