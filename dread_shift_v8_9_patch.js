...
const required={
  "server.js":["/* DREAD SHIFT v8.9 server */",'const BUILD_VERSION = "8.9.0";',"hp:680","prevX:p.x","pointSegmentDistance(z.x,z.y,bulletFromX"],
  "public/client.js":["/* DREAD SHIFT v8.9 client */","wallSnapEnabled=true","updateMetaAttention","showLevelUp","WALL_HALF_THICK=13"],
  "public/index.html":["V8.9.0","wallBuildHud","wallSnapToggle"],
