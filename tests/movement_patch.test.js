...
test("movement and HUD patches remain enabled in release order",()=>{
  ...
  assert.equal(pkg.version,"8.8.1");
  assert.match(pkg.scripts.start,/dread_shift_v8_7_1_patch\.js && node dread_shift_v8_7_2_patch\.js && node dread_shift_v8_8_patch\.js && node dread_shift_v8_8_1_patch\.js && node db_bridge\.js$/);
});
